...
#ifndef PLOTTER2D_OVERLAY_DISPLAY_HPP_
#define PLOTTER2D_OVERLAY_DISPLAY_HPP_
...
{
class Plotter2dOverlayDisplay : public rviz_common::Display
{
  Q_OBJECT
public:
  Plotter2dOverlayDisplay();
  ~Plotter2dOverlayDisplay() override;
...
private:
  boost::circular_buffer<float> data_buffer_;
...
#endif  // PLOTTER2D_OVERLAY_DISPLAY_HPP_